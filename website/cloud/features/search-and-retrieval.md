---
description: Use the advanced search and retrieval capabilities of Spice
---
...
Spice also supports vector search on datasets with preexisting embeddings. See [below](search-and-retrieval.md#pre-existing-embeddings) for compatibility details.
...
4. **Offset Column for Chunked Data:**
   * If the underlying column is chunked, there must be an additional offset column named `<column_name>_offsets` with the following Arrow data type:
     ...
     2. _For instance, `[[0, 100], [101, 200]]` indicates two chunks covering indices 0–100 and 101–200, respectively._

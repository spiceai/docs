...
- `--refresh-sql`  SQL used to refresh the dataset, see [Refresh SQL docs](/docs/features/data-acceleration/data-refresh#refresh-sql).
- `--refresh-mode`  Refresh mode to use, see [Refresh Modes docs](/docs/features/data-acceleration/data-refresh#refresh-modes).

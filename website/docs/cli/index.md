...
For getting started with Spice using the Spice CLI, see the [Getting Started Guide](../getting-started/index).
...
See [Spice CLI command reference](./reference/index) for the full list of available commands.

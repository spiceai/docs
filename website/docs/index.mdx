...
- **Is Spice a CDN for databases?** Yes, Spice enables shipping working datasets to where they’re accessed most, like data-intensive applications or AI contexts, similar to a CDN. [Docs FAQ](/docs/faq)

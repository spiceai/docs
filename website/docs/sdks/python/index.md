...
Native parameterized query support in spicepy is coming soon. For parameterized queries, use ADBC directly. See [Parameterized Queries](/docs/features/query-federation/parameterized-queries) and [ADBC](/docs/api/adbc) for more information.
:::

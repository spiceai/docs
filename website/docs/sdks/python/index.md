...
Native parameterized query support in spicepy is coming soon. For parameterized queries, use ADBC directly. See [Parameterized Queries](../../features/query-federation/parameterized-queries.mdx) and [ADBC](/docs/api/adbc) for more information.
:::

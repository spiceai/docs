...
Use `refresh` method to perform [Accelerated Dataset](../features/data-acceleration) refresh. See full [dataset refresh example](https://github.com/spiceai/spice-java/blob/release/0.4/src/main/java/ai/spice/example/ExampleDatasetRefreshSpiceOSS.java).

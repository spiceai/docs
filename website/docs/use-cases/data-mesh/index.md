...
Perform [federated SQL queries](../../features/query-federation/index.md) across databases, data warehouses, and data lakes using [Data Connectors](../../components/data-connectors/index.md).

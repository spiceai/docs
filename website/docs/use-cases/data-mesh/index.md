...
Perform [federated SQL queries](/docs/features/federated-queries) across databases, data warehouses, and data lakes using [Data Connectors](/docs/components/data-connectors).

...
- **Data Acceleration**: [Documentation](/docs/features/data-acceleration) and [DuckDB Data Accelerator Recipe](https://github.com/spiceai/cookbook/blob/trunk/duckdb/accelerator/README) for an example.
- **AI Gateway**: [Documentation](/docs/features/large-language-models) and [Running Llama3 Locally Recipe](https://github.com/spiceai/cookbook/blob/trunk/llama/README) for details.
- **Vector Search**: [Documentation](/docs/features/search) and [Searching GitHub Files Recipe](https://github.com/spiceai/cookbook/blob/trunk/search_github_files/README).

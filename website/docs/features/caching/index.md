...
Cache metrics can be monitored using the [Prometheus-compatible Metrics Endpoint](/docs/features/observability). The following metrics are available for each cache type:

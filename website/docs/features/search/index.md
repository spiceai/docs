...
- [Performing Vector Search](../search/vector-search.md)
...
For complete SQL UDTF specifications, see [Vector-Based Search SQL UDTF](../search/vector-search.md#sql-udtf).
...
For detailed SQL UDTF instructions, see [Full-Text Search SQL UDTF](../search/full-text.md#searching-with-sql).

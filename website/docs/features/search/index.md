...
For performing full text search, see [Full text Search](../../features/search/full-text).
...
For an entire specification of the `vector_search` UDTF, see [Vector-Based Search](../../features/search/vector-search#sql-udtf).
...
For an entire specification of the `text_search` UDTF, see [Full text Search](../../features/search/full-text#sql-udtf).

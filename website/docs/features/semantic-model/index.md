...
The semantic model is automatically used by [Spice Models](/docs/reference/spicepod/models) as context to produce more accurate and context-aware AI responses.
...
For detailed `metadata` configuration, see the [Dataset Reference](/docs/reference/spicepod/datasets#metadata)
...
For detailed `columns` configuration, see the [Dataset Reference](/docs/reference/spicepod/datasets#columns)

...
- **SQL Integration**: Invoke LLMs directly within SQL queries using the `ai()` function for text generation tasks. See [SQL Reference: ai function](../../reference/sql/scalar_functions.md#ai).
- **Custom Tools**: Provide models with tools to interact with the Spice runtime. See [Tools](../large-language-models/tools/).
- **System Prompts**: Customize system prompts and override defaults for [`v1/chat/completion`](../../api/HTTP/post-chat-completions.api.mdx). See [Parameter Overrides](../large-language-models/parameter_overrides.md).

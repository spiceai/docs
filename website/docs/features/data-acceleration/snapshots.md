...
For the full reference, see [`snapshots` in the Spicepod specification](/docs/reference/spicepod#snapshots) and [`acceleration.snapshots`](/docs/reference/spicepod/datasets#accelerationsnapshots).
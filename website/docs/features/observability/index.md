...
For full configuration details, see the [runtime.telemetry reference](../../reference/spicepod/runtime.md#runtimetelemetry).
...
In addition to these core metrics, individual components can expose their own metrics. For example, the MySQL data connector exposes [connection pool metrics](../../components/data-connectors/mysql.md#metrics). See [Component Metrics](../observability/component_metrics.md) for more information.

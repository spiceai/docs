...
| `dataset_acceleration_refresh_rows_written`<br/>_(count)_            | Cumulative number of rows read from the federated source and written into the accelerated table.                                                                                            |
| `dataset_acceleration_refresh_bytes_written`<br/>_(count)_           | Cumulative number of bytes (Arrow in-memory size) read from the federated source and written into the accelerated table.                                                                    |
...
| `dataset_acceleration_size_bytes`<br/>_(gauge)_                      | Size of the accelerated table storage in bytes.                                                                                                                                             |
...
| `flight_do_put_bytes_written`<br/>_(count)_                          | Cumulative number of bytes (Arrow in-memory size) received and written via Flight DoPut.                                                                                                    |
| `flight_do_put_rows_written`<br/>_(count)_                           | Cumulative number of rows received and written via Flight DoPut.                                                                                                                            |
...
| `scheduler_active_executors_count`<br/>_(gauge)_                     | Number of executors currently connected to the scheduler node. Includes a `node_id` label identifying the scheduler.                                                                        |

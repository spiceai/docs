...
| `catalog_acceleration_tables`<br/><br/>Tables resolved by a CDC-accelerated catalog, labeled by catalog and category (accelerated, skipped, excluded). | _gauge_ | `catalog`, `category` |

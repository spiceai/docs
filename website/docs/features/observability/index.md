...
| `schema_interner_rows`<br/><br/>Number of distinct Arrow schemas currently shared across SQL results-cache entries. Shared schemas are not charged to any entry, so they do not appear in `results_cache_size_bytes`.                        | _gauge_     | —                                                                                                           |
...
| `schema_interner_misses`<br/><br/>Interns that adopted an Arrow schema the pool had not seen. Misses without collapses mean schemas are arriving distinct and nothing is being shared.                                        | _count_     | —                                                                                                           |
...
| `table_set_interner_rows`<br/><br/>Number of distinct input-table sets currently shared across SQL results-cache entries. Shared table sets are not charged to any entry, so they do not appear in `results_cache_size_bytes`.  | _gauge_     | —                                                                                                           |
...
| `table_set_interner_misses`<br/><br/>Interns that adopted an input-table set the pool had not seen. Misses without collapses mean table sets are arriving distinct and nothing is being shared.                               | _count_     | —                                                                                                           |

...
| `dataset_acceleration_last_refresh_time_ms`<br/><br/>Unix timestamp in milliseconds when the last refresh completed. [Disabled by default](../reference/spicepod/runtime#runtimemetrics)                                     | _gauge_     | `dataset`                                                                                                   |
...
| `query_executions`<br/><br/>Number of query executions.                                                                                                                                                                      | _count_     | _(request context)_                                                                                         |

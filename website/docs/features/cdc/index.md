...
When configuring datasets to be accelerated with CDC, ensure that the [data connector](../../components/data-connectors/index) supports CDC and can return a stream of row-level changes. See the [Supported Data Connectors](#supported-data-connectors) section for more information.

...
- The In-Memory Arrow Data Accelerator does not support [indexes](../../features/data-acceleration/indexes.md).
- The In-Memory Arrow Data Accelerator only supports primary-key [constraints](../../features/data-acceleration/constraints.md), not `unique` constraints.

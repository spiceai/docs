...
- The In-Memory Arrow Data Accelerator does not support traditional [indexes](/docs/features/data-acceleration/indexes), but does support hash indexes (experimental) for point lookups.

...
description: 'Production operating guide for the Delta Lake data connector: resilience controls, authentication, metrics, and observability.'
sidebar_position: 10
...
Production operating guide for the **Delta Lake Data Connector** covering resilience tuning, authentication, capacity sizing, metrics, and observability.

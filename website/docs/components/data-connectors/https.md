...
| `http_auth_refresh_token` | component, secret   | yes (for OAuth) | Long-lived refresh token. Exchanged on startup for the first access token.                                                                                                                     |
...
| `http_auth_client_secret` | component, secret   | confidential    | `client_secret`. Must be paired with `http_auth_client_id`.                                                                                                                                    |

...
description: 'Production operating guide for the S3 data connector: resilience controls, authentication, metrics, and observability.'
sidebar_position: 10
...
Production operating guide for the **S3 Data Connector** covering resilience tuning, authentication, capacity sizing, metrics, and observability.

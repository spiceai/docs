...
The FTP/SFTP Data Connector enables federated SQL query across [supported file formats](/docs/components/data-connectors/index.md#file-formats) stored on FTP/SFTP servers.
...
| `ftp_pass`                  | Password for FTP authentication. Use [secrets](../secret-stores/index) syntax: `${secrets:my_ftp_pass}`.          |
...
| `sftp_pass`                 | Password for SFTP authentication. Use [secrets](../secret-stores/index) syntax: `${secrets:my_sftp_pass}`.        |

...
Each query retrieves data from the S3 source, which might result in substantial network requests and bandwidth consumption. This can affect network performance and incur costs related to data transfer from S3.

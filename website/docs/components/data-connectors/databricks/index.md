...
| `connect_timeout`             | Optional. Timeout for establishing TCP/TLS connections. Applies in `delta_lake` and `sql_warehouse` modes. Default: `10s`. E.g. `connect_timeout: 15s`                                                                                                                   |

...
description: 'Production operating guide for the Spice.ai Cloud Platform data connector: resilience controls, authentication, metrics, and observability.'
sidebar_position: 10
...
Production operating guide for the **Spice.ai Cloud Platform Data Connector** covering resilience tuning, authentication, capacity sizing, metrics, and observability.

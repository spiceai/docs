---
title: 'Local (File) Embedding Deployment Guide'
sidebar_label: 'Deployment Guide'
description: 'Production operating guide for the Local (File) embedding: resilience controls, authentication, metrics, and observability.'
sidebar_position: 10
...
Production operating guide for the **Local (File) Embedding** covering resilience tuning, authentication, capacity sizing, metrics, and observability.
...
Operational metrics exposed by the embedding. See [Component Metrics](../../../features/observability/component_metrics) for general configuration.
...
Spans emitted by the embedding for the [task history](../../../reference/task_history) system.

...
- **System Prompts**: Declaratively define system prompts and default values for [`v1/chat/completion`](../../api/HTTP/post-chat-completions.api.mdx) parameters. See [Parameter Overrides](../../features/large-language-models/parameter_overrides.md). Use Jinja-templating to parameterise system prompts per request see [Parameterized prompts](docs/features/large-language-models/parameterized_prompts).

...
For a complete specification of worker configuration, routing rules, and available options, refer to the [Spicepod Workers Reference](https://your-docs-domain.com/docs/reference/spicepod/workers.md#models).

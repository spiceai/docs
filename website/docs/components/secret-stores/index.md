...
Supported secret stores include: [`env`](./env/), [`kubernetes`](./kubernetes/), [`keyring`](./keyring/), and [`aws_secrets_manager`](./aws-secrets-manager/). The `env` secret store is loaded by default.

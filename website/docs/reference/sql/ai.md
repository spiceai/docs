...
Models must be configured in `spicepod.yaml` under the `models` section. See [Large Language Models](../../features/large-language-models/index.md) for detailed configuration.
...
Each `ai()` function invocation creates an `ai` task in the [task_history](../../reference/task_history.md) table, which tracks execution time, input prompts, outputs, and errors.
...
Embedding models must be configured in `spicepod.yaml`. See [Embeddings](../../features/embeddings/index.md) for configuration details.
...
- [Large Language Models](../../features/large-language-models/index.md)
- [Embeddings](../../features/embeddings/index.md)
- [Vector Search](../../features/search/vector-search.md)

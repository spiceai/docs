...
The description of the dataset. Used as part of the [Semantic Data Model](../../features/semantic-model.md).
...
Optional. A description of the column's contents and purpose. Used as part of the [Semantic Data Model](../../features/semantic-model.md).
...
Optional. Additional key-value metadata for the dataset. Used as part of the [Semantic Data Model](../../features/semantic-model.md).

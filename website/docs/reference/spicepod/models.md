...
- Setting default OpenAI request parameters for language models, see [parameter overrides](/docs/features/large-language-models/parameter_overrides).
- Allowing Language models to perform actions against spice (e.g. making SQL queries), via language model tool use, see [runtime tools](/docs/features/large-language-models/tools).

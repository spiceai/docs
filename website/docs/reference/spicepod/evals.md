...
The [dataset](./datasets) to use for this evaluation. Must reference a valid dataset defined in the Spicepod configuration.

## `scorers`

A list of scoring methods to apply during the evaluation. Each scorer defines how a [model's](./models) outputs will be measured against an expected result.

A full list of scorers can be found [here](../../features/large-language-models/evals#eval-scorers).

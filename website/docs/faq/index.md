...
Spice supports local model serving (e.g., Llama3) and gateways to hosted AI platforms including OpenAI, Anthropic, xAI, and Nvidia NIMs. [Learn More](/docs/features/large-language-models/index).
...
Visit the [Spice.ai Getting Started Guide](/docs/getting-started/index) to install Spice, connect data sources, and begin querying. Spice installs the GPU-accelerated runtime by default (if supported).

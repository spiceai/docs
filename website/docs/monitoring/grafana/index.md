...
View the [Kubernetes](../../deployment/kubernetes/helm) deployment guide for configuring the Prometheus Operator to scrape metrics from the Spice instances in Kubernetes.

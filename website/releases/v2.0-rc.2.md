...
type: blog
authors: [ewgenius]
tags: [release, distributed-query, cayenne, datafusion, delta-lake, databricks, adbc, data-connector]
...
- **New Catalog Connectors**: Added catalog connectors for [PostgreSQL](https://spiceai.org/docs/next/components/catalogs/postgres), [MySQL](https://spiceai.org/docs/next/components/catalogs/mysql), [MSSQL](https://spiceai.org/docs/next/components/catalogs/mssql), and [Snowflake](https://spiceai.org/docs/next/components/catalogs/snowflake).
...
**Full Changelog**: [https://github.com/spiceai/spiceai/compare/v2.0.0-rc.1...v2.0.0-rc.2](https://github.com/spiceai/spiceai/compare/v2.0.0-rc.1...v2.0.0-rc.2)
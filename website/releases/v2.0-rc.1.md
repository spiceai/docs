...
type: blog
authors: [sgrebnov]
tags: [release, distributed-query, cayenne, datafusion, ducklake, gcp, rust, data-connector]
...
For more details, see the [Distributions documentation](https://github.com/spiceai/spiceai/blob/trunk/docs/DISTRIBUTIONS.md).
...
**Full Changelog**: [https://github.com/spiceai/spiceai/compare/v1.11.2...v2.0.0-rc.1](https://github.com/spiceai/spiceai/compare/v1.11.2...v2.0.0-rc.1)
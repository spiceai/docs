---
date: 2022-04-21
title: 'Spice.ai v0.6.1-alpha'
type: blog
linkTitle: 'Spice.ai v0.6.1-alpha is now available'
authors: [lukekim]
categories: [release]
tags: [arrow, performance, data-connector, data processors, spice.xyz]
---
...
![Spice.xyz](https://miro.medium.com/max/1400/1*-SXXeycmH0haRsG3Wv3u6w.png)

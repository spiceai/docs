---
date: 2026-05-01
title: 'Spice v2.0-rc.4 (Apr 30, 2026)'
type: blog
authors: [peasee]
tags: [release, elasticsearch, data-connector, postgres, search, embedding, duckdb, azure, mcp]
...
The new [Elasticsearch](https://spiceai.org/docs/components/data-connectors/elasticsearch) data connector enables querying Elasticsearch indexes as SQL tables with full hybrid search support. Currently available in Spice.ai Enterprise.
...
**Full Changelog**: [https://github.com/spiceai/spiceai/compare/v2.0.0-rc.3...v2.0.0-rc.4](https://github.com/spiceai/spiceai/compare/v2.0.0-rc.3...v2.0.0-rc.4)
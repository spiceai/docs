    ...
    const html = `
      ...
      <div style="display: flex; flex-direction: column; height: 100%; width: 100%; background-image: url('${url.protocol}//${url.host}/img/bg-articles.png'); background-size: 100% 100%;">
        ...
        <div style="display: flex; width: 100%;">
          ...
          <h2 style="font-family: 'Open Sans', sans-serif; font-size: 48px; font-weight: bold; letter-spacing: -0.05em; color: white; text-align: left; margin-left: 10%; width: 80%; margin-top: 40%;">
            ${title}
          </h2>
          </div>
        </div>

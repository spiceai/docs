...
If you are interested in partnering, we'd love to talk. Try out [Spice.ai](https://spiceai.org), [email us](mailto:hey@spice.ai) "hey," get in touch on [Slack](http://spiceai.org/slack), or reach out on [Twitter](https://twitter.com/spice_ai).

...
<Quote
  ...
  company='Twilio'
  imageUrl='/img/blog/2024/announcing-1.0-stable/peter-janovsky.jpeg'
>
  "Spice opened the door to take these critical control-plane datasets and move them next to our
  services in the runtime path."
</Quote>
...
<Quote
  ...
  company='Twilio'
  imageUrl='/img/blog/2024/announcing-1.0-stable/david-blum.jpeg'
>
...
<Quote
  ...
  company='Barracuda'
  imageUrl='/img/blog/2024/announcing-1.0-stable/david-stancu.jpeg'
>
...
<Quote
  ...
  title='Principal Software Engineer'
  company='Barracuda'
  imageUrl='/img/blog/2024/announcing-1.0-stable/darin-douglass.jpeg'
>
...
<Quote
  ...
  company='NRC Health'
  imageUrl='/img/blog/2024/announcing-1.0-stable/dustin-warner.jpeg'
>
  "What I like the most about Spice, it's very easy to collect data from different data sources and
  I am able to chat with this data and do everything in one place."
</Quote>
...
<Quote
  ...
  company='NRC Health'
  imageUrl='/img/blog/2024/announcing-1.0-stable/taher-ahmed.jpeg'
>
  "I explored AI, embeddings, search algorithms, and features with our own database. I read a lot
  about this, but it was so much easier to use Spice than doing it from scratch."
</Quote>
...
<div style={{ display: 'flex', justifyContent: 'center', marginBottom: '15px' }}>
  <ReactPlayer controls url='https://www.youtube.com/watch?v=A0QdHVUKfAk' />
</div>
...
- **[Slack](https://spiceai.org/slack)**: Connect with the team and the community

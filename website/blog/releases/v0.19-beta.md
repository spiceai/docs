...
For a full list of supported files, see the [Object Store File Formats](https://docs.spiceai.org/components/data-connectors/index.md#object-store-file-formats) documentation.

...
- An anonymous identifier for the Spicepod, computed as `sha256(spicepod.name)`.
  - The code to calculate these identifiers is here: [https://github.com/spiceai/spiceai/blob/v1.9.2/crates/telemetry/src/anonymous.rs#L47-L70](https://github.com/spiceai/spiceai/blob/v1.9.2/crates/telemetry/src/anonymous.rs#L47-L70)
- Various metrics related to usage of features of the runtime, see the full list here: [https://github.com/spiceai/spiceai/blob/v1.9.2/crates/telemetry/src/lib.rs](https://github.com/spiceai/spiceai/blob/v1.9.2/crates/telemetry/src/lib.rs)

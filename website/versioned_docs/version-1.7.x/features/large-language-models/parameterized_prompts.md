...
Spice supports defining system prompts for Large Language Models (LLM)s in the [spicepod](../../features/large-language-models/parameter_overrides#system-prompt).

...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `file_format`               | Specifies the data file format. Required if the format cannot be inferred from the `from` path. Refer to [Object Store File Formats](../../components/data-connectors#object-store-file-formats) for details. |
...
For CSV-specific parameters, see [CSV Parameters](../../reference/file_format#csv).

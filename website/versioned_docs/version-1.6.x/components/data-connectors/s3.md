...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `file_format`               | Specifies the data format. Required if it cannot be inferred from the object URI. Options: `parquet`, `csv`, `json`. Refer to [Object Store File Formats](../../components/data-connectors/index#object-store-file-formats) for details. |
...
For additional CSV parameters, see [CSV Parameters](../../reference/file_format#csv)

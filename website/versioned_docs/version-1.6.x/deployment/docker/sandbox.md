...
To debug issues with the sandbox container, see the [Debugging Sandbox Container](../troubleshooting/index#debugging-sandbox-container) section of the troubleshooting guide.

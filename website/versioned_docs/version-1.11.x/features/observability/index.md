...
| `dataset_acceleration_last_refresh_time_ms`<br/>_(gauge)_            | Unix timestamp in milliseconds when the last refresh completed. [Disabled by default](/docs/reference/spicepod/runtime.md#runtimemetrics)                                                         |

...
A SQL table function can wrap the [search functions](../../reference/sql/search.md) — [`vector_search()`](../../reference/sql/search.md#vector-search-vector_search), [`text_search()`](../../reference/sql/search.md#full-text-search-text_search), and either of them nested inside [`rrf()`](../../reference/sql/search.md#reciprocal-rank-fusion-rrf) — passing its own argument through as the search query. This packages a hybrid-search query as one named, callable function:

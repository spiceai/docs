...
To work around this limitation, use [views](../../features/views/index.md) to convert `LargeUtf8` columns to `Utf8` by casting them with `arrow_cast(<column>, 'Utf8')`. A `::TEXT` cast does not produce `Utf8`: it plans as `Utf8View`.

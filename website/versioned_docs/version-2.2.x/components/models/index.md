...
> **Note**: Support for traditional machine learning (ONNX) models was removed in v2.2. See [Machine Learning Models](../../features/machine-learning-models/index.md) for details.

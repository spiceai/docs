...
The `spice.ai` model source serves large language models only. Support for loading and serving traditional machine learning (ONNX) models was removed in v2.2 — see [Machine Learning Models](../../features/machine-learning-models/index.md).

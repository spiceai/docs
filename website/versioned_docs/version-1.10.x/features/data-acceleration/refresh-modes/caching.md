...
- [Data Refresh](../data-acceleration/data-refresh) - Overview of all refresh modes
- [Refresh SQL](../data-acceleration/data-refresh#refresh-sql) - Using SQL to control refresh behavior

...
Cache metrics can be monitored using the [Prometheus-compatible Metrics Endpoint](../observability/index). The following metrics are available for each cache type:

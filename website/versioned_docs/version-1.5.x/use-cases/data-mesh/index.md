...
Perform [federated SQL queries](../../features/query-federation) across databases, data warehouses, and data lakes using [Data Connectors](../../components/data-connectors).

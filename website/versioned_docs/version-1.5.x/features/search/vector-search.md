...
Spice also supports vector search on datasets with preexisting embeddings. See [below](../../components/embeddings#passthrough-embeddings) for compatibility details.

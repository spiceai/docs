...
Amazon S3 (Simple Storage Service) is a scalable object storage service that allows users to store, manage, and retrieve any amount of data from anywhere on the web.
